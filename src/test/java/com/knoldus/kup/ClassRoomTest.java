...
public class ClassRoomTest {
    ...
    public void setUpClassRoom() throws Exception {
        Student std1 = new Student("Deepak", 1, Optional.of("python"));
        Student std2 = new Student("Shivam", 2, Optional.empty());
        Student std3 = new Student("Prakhar", 3, Optional.empty());
        Student std4 = new Student("Vaishali", 4, Optional.of("Java"));

        Student std5 = new Student("Raju", 5, Optional.of(".NET"));
        Student std6 = new Student("Cheeru", 6, Optional.of("NodeJS"));
        Student std7 = new Student("Pratibha", 7, Optional.of("JavaScript"));
        Student std8 = new Student("Uzair", 10, Optional.of("Angular"));
        Student std9 = new Student("Arunesh", 11, Optional.of("C++"));
    ...
    public void GetDifferentSubjectsThroughRoomId_AndCorrectIfSubjectsFoundByRoomId() {
        List<Optional<String>> anticipatedSubjects = Arrays.asList(Optional.of(".NET"), Optional.of("NodeJS"), Optional.of("JavaScript"),Optional.of("Angular"), Optional.of("C++"));
        List<Optional<String>> realSubjects = secondClassRoom.toGetDistinctSubjectsThroughRoomId("xyz");
